...
return new class extends Migration
{
    public function up()
    {
        ...
        DB::statement('UPDATE users SET state_id = city_id');
        Schema::table('users', function (Blueprint $table) {
        ...
        DB::statement('UPDATE users SET city_id = area_id');
        Schema::table('users', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        DB::statement('UPDATE users SET city_id = state_id');
        Schema::table('users', function (Blueprint $table) {
        ...
        DB::statement('UPDATE users SET area_id = city_id');
        Schema::table('users', function (Blueprint $table) {
