        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('docotr-degree.update', $docotr_degree) }}" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <!-- Name -->
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name_en" name="name_en" type="text" value="{{ $docotr_degree->name_en }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name_ar" name="name_ar" type="text" value="{{ $docotr_degree->name_ar }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="code_en" name="code_en" type="text" value="{{ $docotr_degree->code_en }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="code_ar" name="code_ar" type="text" value="{{ $docotr_degree->code_ar }}"
