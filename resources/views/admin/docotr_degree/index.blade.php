            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="doc-badge me-3">Degrees<span
                                class="ms-1">{{ count($degrees) }}</span>
                            {{-- <span class="ms-1">{{ count(\App\Models\User::query()->where('user_type', 'U')->get()) }}</span> --}}
                        </div>
                        <a href="{{ route('docotr-degree.create') }}" class="btn btn-primary btn-add"><i
                                class="feather-plus-square me-1"></i> Add New Degree</a>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <div class="actions">
                                                        ...
                                                        @if($type->deleted_at) <!-- Check if type is soft deleted -->
                                                            ...
                                                            <form method="POST" id="force-delete{{ $type->id }}"
                                                                action="{{ route('docotr-degree.force-delete', $type) }}">
                                                                @csrf
                                                                @method('delete')
                                                            </form>
                                                        @else
                                                            ...
                                                            <form method="POST" id="delete{{ $type->id }}"
                                                                action="{{ route('docotr-degree.destroy', $type) }}">
                                                                @csrf
                                                                @method('delete')
                                                            </form>
                                                        @endif
