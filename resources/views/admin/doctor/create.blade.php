                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('doctor.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-form-label col-md-2">{{ __('admin.doctor.password')  }}</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-form-label col-md-2">{{ __('admin.doctor.confirm_doctor')  }}</label>
                                <div class="col-md-10">
                            ...
                            <!-- Speciality -->
                            <div class="form-group row">
                                <label for="speciality_id" class="col-form-label col-md-2">{{ __('admin.doctor.speciality')  }}</label>
                                <div class="col-md-10">
                            ...
                            <!-- gender -->
                            <div class="form-group row">
                                <label for="speciality_id" class="col-form-label col-md-2">{{ __('admin.doctor.gender')  }}</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-row row">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                    <input type="text" class="form-control" id="address" name="address" placeholder="{{ __('admin.doctor.enter_doctor_address')  }}" required>
                                    @error('address')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <!-- hospital -->
                            <div class="form-group row">
                                <label for="hospital_id" class="col-form-label col-md-2">{{ __('admin.doctor.hospital')  }}</label>
                                <div class="col-md-10">
                            ...
                            <!-- Pricing -->
                            <div class="form-group row">
                                <label for="pricing" class="col-form-label col-md-2">{{ __('admin.doctor.pricing')  }} (SAR)</label>
                                <div class="col-md-10">
                            ...
                            @endfor -->
                            <button class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i> {{ __('admin.doctor.add_doctor')  }}
                            </button>
                        </form>
                    </div>
                </div>
