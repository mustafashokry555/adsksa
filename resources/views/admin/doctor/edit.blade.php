                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('doctor.update', $doctor) }}"
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-form-label col-md-2">{{ __('admin.doctor.doctor_name')  }}</label>
                            <div class="col-md-10">
                                <input id="name"
                                        name="name"
                                        type="text"
                        ...
                        <!-- Email -->
                        <div class="form-group row">
                            <label for="email" class="col-form-label col-md-2">{{ __('admin.doctor.doctor_email')  }}</label>
                            <div class="col-md-10">
                                <input id="email"
                                        name="email"
                                        type="email"
                                        ...
                                        class="form-control"
                                        placeholder="{{ __('admin.doctor.enter_doctor_email')  }}"
                                        required
                                >
                                @error('email')
                                <div class="text-danger pt-2">
                        ...
                        <!-- Speciality -->
                        <div class="form-group row">
                            <label for="speciality_id" class="col-form-label col-md-2">{{ __('admin.doctor.specialities')  }}</label>
                            <div class="col-md-10">
                        ...
                        <!-- gender -->
                        <div class="form-group row">
                            <label for="gender" class="col-form-label col-md-2">{{ __('admin.doctor.gender')  }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-row row">
                            <div class="form-group row">
                                <label class="col-form-label col-md-2" for="address">{{ __('admin.doctor.address')  }}</label>
                                <div class="col-md-10">
                                <input type="text" class="form-control" id="address" name="address"
                                        placeholder="{{ __('admin.doctor.enter_doctor_name')  }}" value="{{ old('address',$doctor->address) }}">
                                @error('address')
                                <div class="text-danger pt-2">
                                    {{$message}}
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="country" placeholder="{{ __('admin.doctor.enter_country')  }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="state" name="state" placeholder="{{ __('admin.doctor.enter_state')  }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="zip_code" name="zip_code"
                                        placeholder="{{ __('admin.doctor.enter_zip_code')  }}" value="{{ old('zip_code', $doctor->zip_code) }}">
                                @error('zip_code')
                                <div class="text-danger pt-2">
                                    {{$message}}
                                </div>
                        ...
                        <!-- hospital -->
                        <div class="form-group row">
                            <label for="hospital_id" class="col-form-label col-md-2">{{ __('admin.doctor.doctor_name')  }}</label>
                            <div class="col-md-10">
                        ...
                        <!-- Pricing -->
                        <div class="form-group row">
                            <label for="pricing" class="col-form-label col-md-2">{{ __('admin.doctor.doctor_name')  }} (SAR)</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                                <label for="email" class="col-form-label col-md-2">{{ __('admin.doctor.doctor_name')  }}</label>
                                <div class="col-md-10">
                        ...
                        <!-- Profile Image -->
                        <div class="form-group row">
                            <label for="profile_image" class="col-form-label col-md-2">{{ __('admin.doctor.image')  }}</label>
                            <div class="col-md-10">
                        ...
                        <button class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i>{{ __('admin.doctor.update_doctor')  }}</button>
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-auto d-flex">
                            <ul role="tablist" class="nav nav-pills card-header-pills float-end">
                                <li class="nav-item" role="presentation">
                                    <a href="#regular-avail" data-bs-toggle="tab" class="nav-link active" aria-selected="true" role="tab">{{ __('admin.doctor.regular_availability')  }}</a>
                                </li>
                                <!-- <li class="nav-item" role="presentation">
                                    <a href="#onetime-avail" data-bs-toggle="tab" class="nav-link" aria-selected="false" role="tab" tabindex="-1">One-time Availability</a>
                                </li> -->
                                <li class="nav-item" role="presentation">
                                    <a href="#unavail" data-bs-toggle="tab" class="nav-link" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.unavailability')  }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <div class="schedule-header">
                                                ...
                                                <div class="schedule-nav">
                                                    <ul class="nav nav-tabs nav-tabs-solid nav-justified" role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" data-bs-toggle="tab" href="#slot_sunday" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.sunday')  }}</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link active" data-bs-toggle="tab" href="#slot_monday" aria-selected="true" role="tab">{{ __('admin.doctor.monday')  }}</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" data-bs-toggle="tab" href="#slot_tuesday" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.tuesday')  }}</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" data-bs-toggle="tab" href="#slot_wednesday" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.wednesday')  }}</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" data-bs-toggle="tab" href="#slot_thursday" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.thursday')  }}</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" data-bs-toggle="tab" href="#slot_friday" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.friday')  }}</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" data-bs-toggle="tab" href="#slot_saturday" aria-selected="false" tabindex="-1" role="tab">{{ __('admin.doctor.saturday')  }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- /Schedule Nav -->
                                                ...
                                                <div id="slot_sunday" class="tab-pane fade" role="tabpanel">
                                                    ...
                                                    @if ($sundaySlots)
                                                        ...
                                                        <div class="doc-times">
                                                            ...
                                                            <button type="button" class="btn mx-1 btn-sm btn-outline-secondary">{{date("h:i A",strtotime($slot['start_time']))}} - {{date("h:i A",strtotime($slot['end_time']))}}</button>
                                                            @endforeach
                                                        </div>
                                                        <!-- /Slot List -->
                                                    @else
