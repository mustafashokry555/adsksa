            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="doc-badge me-3"> {{ __('admin.insurance.insurances')  }}<span class="ms-1">{{ count($insurance) }}</span>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="datatable table table-borderless hover-table" id="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ __('admin.insurance.name')  }}</th>
                                        <th>{{ __('admin.insurance.email')  }}</th>
                                        <th>{{ __('admin.insurance.phone1')  }}</th>
                                        <th>{{ __('admin.insurance.phone2')  }}</th>
                                        <th>{{ __('admin.insurance.city')  }},{{ __('admin.insurance.state')  }},{{ __('admin.insurance.address')  }}</th>
                                    ...
                                    @forelse($insurance as $item)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a class="text-black"
                                                       href="{{ route('insurances.edit', $item) }}">
