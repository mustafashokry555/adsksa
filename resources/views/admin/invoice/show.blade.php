                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="invoice-info">
                                ...
                                <p class="invoice-details invoice-details-two">
                                    Appoitment Date :
                                    {{ date('d M Y', strtotime(@$invoice->appointment?->appointment_date)) }},
                                    {{ date('H:i A', strtotime(@$invoice->appointment?->appointment_date)) }} <br>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                                $vat_amount =
                                                    $invoice->subtotal == 0
                                                        ? 0
                                                        : $invoice->subtotal * ($invoice->vat / 100);
                                ...
                                <table class="invoice-table-two table">
                                    <tbody>
                                        <tr>
                                            <th>Subtotal:</th>
                                            <td><span>
                                                    {{ $invoice->subtotal == 0 ? 'FREE' : 'SAR ' . $invoice->subtotal }}</span>
                                            </td>
                                        </tr>
                                        <tr>
