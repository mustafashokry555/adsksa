...
@section('title', 'Offer Schedule Settings')
@push('styles')
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    @php
                        $availability = $offer->regularAvailabilities->first();
                    @endphp
                    <form method="POST" action="{{ route('hospital.offer-schedule.regular.update',['offer'=> $offer, 'week_day' => $weekDay]) }}">
                        @csrf
