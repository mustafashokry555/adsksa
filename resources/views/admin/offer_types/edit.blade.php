            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Edit Offer Type</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('offer-types.update', $offer_type) }}" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <!-- Name -->
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name_en" name="name_en" type="text" value="{{ $offer_type->name_en }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name_ar" name="name_ar" type="text" value="{{ $offer_type->name_ar }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select id="status" name="status" class="form-select select" required>
                                        <option value="1" {{ $offer_type->status == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ $offer_type->status == 0 ? 'selected' : '' }}>Not Active</option>
                                    </select>
                                    @error('status')
                                        <div class="text-danger pt-2">
                                            {{ $message }}
