                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('patient.update', $patient) }}"
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-form-label col-md-2">{{ __('admin.patient.patient_name')  }}</label>
                                <div class="col-md-10">
                                    <input
                                        id="name"
                                        name="name"
                                        ...
                                        value="{{ $patient->name }}"
                                        class="form-control"
                                        placeholder="{{ __('admin.patient.enter_patient_name')  }}"
                                        required
                                    >
                                    @error('name')
                            ...
                            <!-- Email -->
                            <div class="form-group row">
                                <label for="email" class="col-form-label col-md-2">{{ __('admin.patient.patient_email')  }}</label>
                                <div class="col-md-10">
                                    <input
                                        id="email"
                                        name="email"
                                        ...
                                        value="{{ $patient->email }}"
                                        class="form-control"
                                        placeholder="{{ __('admin.patient.enter_patient_email')  }}"
                                        required
                                    >
                                    @error('email')
                                    <div class="text-danger pt-2">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-form-label col-md-2">{{ __('admin.patient.patient_mobile')  }}</label>
                                <div class="col-md-10">
                                    <input  name="mobile" type="number" value="{{$patient->mobile}}" class="form-control"
                                           placeholder="9766443322" required>
                                    @error('mobile')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group row">
                                <label for="gender" class="col-form-label col-md-2">{{ __('admin.patient.gender')  }}</label>
                                <div class="col-md-10">
                            ...
                            {{-- status --}}
                            <input type="hidden" name="user_type" id="user_type" value="U">
                            <input type="hidden" name="status" id="user_type" value="Active">
                            <!-- <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-form-label col-md-2">{{ __('admin.patient.password')  }}</label>
                                <div class="col-md-10">
                            ...
                            <!-- Profile Image -->
                            <div class="form-group row">
                                <label for="profile_image" class="col-form-label col-md-2">{{ __('admin.patient.image')  }}</label>
                                <div class="col-md-10">
                            ...
                            <button class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i> {{ __('admin.patient.update_patient_details')  }}
                            </button>
                        </form>
                    </div>
                </div>
