            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="doc-badge me-3">{{ __('admin.patient.patients')  }} <span class="ms-1">{{count($patients)}}</span>
                                            ...
                                            <form action="{{route('patient.index')}}">
                                                ...
                                                <div class="selectBox-cont">
                                                    <label class="custom_check w-100">
                                                        <input type="checkbox" name="status[]" value="Active" {{in_array('Active',$status)?'checked':''}}>
                                                        <span class="checkmark"></span> Enabled
                                                    </label>
                                                    <label class="custom_check w-100">
                                                        <input type="checkbox" name="status[]" value="Inactive" {{in_array('Inactive',$status)?'checked':''}}>
                                                        <span class="checkmark"></span> Disabled
                                                    </label>
                                                    <p class="lab-title">By Blood Type</p>
                                                    <label class="custom_check w-100">
                                                        <input type="checkbox" name="blood_group[]" value="AB+" {{in_array('AB+',$bloodGroup)?'checked':''}}>
                                                        <span class="checkmark"></span> AB+
                                                    </label>
                                                    <label class="custom_check w-100">
                                                        <input type="checkbox" name="blood_group[]"  value="O-" {{in_array('O-',$bloodGroup)?'checked':''}}>
                                                        <span class="checkmark"></span> O-
                                                    </label>
                                                    <label class="custom_check w-100">
                                                        <input type="checkbox" name="blood_group[]" value="B-" {{in_array('B-',$bloodGroup)?'checked':''}}>
                                                        <span class="checkmark"></span> B-
                                                    </label>
                                                    <label class="custom_check w-100">
                                                        <input type="checkbox" name="blood_group[]" value="A+" {{in_array('A+',$bloodGroup)?'checked':''}}>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                                                           <a href="#" data-bs-target="#patientlist" data-bs-toggle="modal"><img class="avatar avatar-img" src="{{$patient->profile_image }}" alt="User Image"></a>
