            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="doc-badge me-3">{{__('admin.speciality.specialities') }} <span class="ms-1">{{ count($specialities) }}</span>
                        </div>
                                        ...
                                        <div id="checkBox">
                                            ...
                                            <form action="{{route('speciality.index')}}">
                                                ...
                                                <label class="custom_radio w-100">
                                                    <input type="radio" name="order" value="id" {{$orderBy=='id'?'checked':''}}>
                                                    <span class="checkmark"></span> ID
                                                </label>
                                                <label class="custom_radio w-100 mb-4">
                                                    <input type="radio" name="order" value="updated_at" {{$orderBy=='updated_at'?'checked':''}}>
                                                    <span class="checkmark"></span> Date Modified
                                                </label>
                                                <p class="lab-title">Sort By</p>
                                                <label class="custom_radio w-100">
                                                    <input type="radio" name="sort" value="asc" {{$order=='asc'?'checked':''}}>
                                                    <span class="checkmark"></span> Ascending
                                                </label>
                                                <label class="custom_radio w-100 mb-4">
                                                    <input type="radio" name="sort" value="desc"  {{$order=='desc'?'checked':''}}>
                            ...
                            <div class="table-responsive">
                                <table class="datatable table table-borderless hover-table" id="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{__('admin.speciality.name') }}</th>
