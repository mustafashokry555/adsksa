        ...
        <div class="page-header p-8 m-2">
            <div class="row align-items-center">
                <div class="col-md-12 d-flex justify-content-end">
                    <div class="doc-badge me-3">{{ __('hospital.appointments.appointments') }} <span
                                                                ...
                                                                <div class="d-flex justify-content-end gap-3">
                                                                    @if ($appointment->status == 'P')
                                                                        <form method="POST"
                                                                            ...
                                                                            <button type="submit"
                                                                                ...
                                                                                {{ __('hospital.appointments.accept') }}
                                                                            </button>
                                                                        </form>
                                                                        <form method="POST"
                                                                            action="{{ route('update_appointment_status', $appointment) }}">
                                                                            ...
                                                                            <button type="submit"
                                                                                ...
                                                                                {{ __('hospital.appointments.cancel') }}
                                                                            </button>
                                                                        </form>
                                                                    @elseif($appointment->status == 'D')
                                                                        <form method="POST"
                                                                    ...
                                                                    @else
                                                                        <a href="javascript:void(0);"
                                                                            class="btn btn-sm bg-success-light">
                                                                            <i class="fas fa-check"></i>
                                                                            {{ __('hospital.appointments.confirmed') }}
                                                                        </a>
                                                                        <form method="POST"
                                                                            action="{{ route('update_appointment_status', $appointment) }}">
                                                                            @method('patch')
