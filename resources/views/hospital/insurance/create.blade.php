                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('insurances.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name" name="name" type="text" class="form-control"
                                           placeholder="{{ __('hospital.insurance.enter_name')  }}" required>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="image" name="email" class="form-control" placeholder="{{ __('hospital.insurance.enter_email')  }}" type="email" required>
                                    @error('email')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="image" name="phone1" class="form-control" placeholder="{{ __('hospital.insurance.enter_phone1_no')  }}" type="number" required>
                                    @error('phone1')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="image" name="phone2" class="form-control" placeholder="{{ __('hospital.insurance.enter_phone2_no')  }}" type="number" required>
                                    @error('phone1')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="image" name="city" class="form-control" placeholder="{{ __('hospital.insurance.enter_city')  }}" type="text" required>
                                    @error('city')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="image" name="state" class="form-control" placeholder="{{ __('hospital.insurance.enter_state')  }}" type="text" required>
                                    @error('state')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="image" name="fax" class="form-control" placeholder="{{ __('hospital.insurance.enter_fax')  }}" type="text" required>
                                    @error('state')
                                    <div class="text-danger pt-2">
                                        {{$message}}
                                    </div>
                            ...
                            <button class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i> {{ __('hospital.insurance.add_insurance')  }}
                            </button>
                        </form>
                    </div>
                </div>
