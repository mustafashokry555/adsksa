    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hospital.offer-schedule.regular',['offer'=> $offer, 'week_day' => $weekDay]) }}">
                        @csrf
                        <div class="form-group row">
                            <div class="col-lg-4">
                                <label for="time_interval" class="col-form-label ">{{ __('hospital.offer.time_interval')  }} <small>({{ __('hospital.doctor.minutes')  }})</small></label>
