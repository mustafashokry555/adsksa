                    ...
                    <div class="col-sm">
                        <form method="POST" action="{{ route('hospital.update', $hospital) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="hospital_name_en" name="hospital_name_en"
                                        value="{{ $hospital->hospital_name_en }}" type="text" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="hospital_name_ar" name="hospital_name_ar"
                                        value="{{ $hospital->hospital_name_ar }}" type="text" class="form-control"
                            ...
                            <div class="form-group row">
                                <label for="email"
                                    class="col-form-label col-md-2">{{ __('admin.hospital.email') }}</label>
                                <div class="col-md-10">
                                    <input id="mail" name="mail" value="{{ $hospital->mail ?? '' }}"
                                        type="mail" class="form-control" placeholder="Enter Hospital Mail">
                                    @error('mail')
                                        <div class="text-danger pt-2">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="facebook" name="facebook" value="{{ $hospital->facebook ?? '' }}"
                                        type="text" class="form-control" placeholder="Enter Hospital Facebook">
                                    @error('facebook')
                                        <div class="text-danger pt-2">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="instagram" name="instagram" value="{{ $hospital->instagram ?? '' }}"
                                        type="text" class="form-control" placeholder="Enter Hospital Instagram">
                                    @error('instagram')
                                        <div class="text-danger pt-2">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="tiktok" name="tiktok" value="{{ $hospital->tiktok ?? '' }}"
                                        type="text" class="form-control" placeholder="Enter Hospital Tiktok">
                                    @error('tiktok')
                                        <div class="text-danger pt-2">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select id="hospital_type_id" name="hospital_type_id" class="form-select select"
                                        required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="address" name="address" value="{{ $hospital->address }}"
                                        type="text" class="form-control"
                                        placeholder="{{ __('admin.hospital.enter_location') }}" required>
                                    @error('address')
                                        <div class="text-danger pt-2">
                                            {{ $message }}
                                        </div>
                                    ...
                                    @if ($hospital->profile_images)
                                        @foreach ($hospital->profile_images as $index => $image)
                                            <div class="d-inline-block position-relative" id="image-{{ $index }}">
                                                {{-- <p>{{ $image }}</p> --}}
                                                <img src="{{ $hospital->images_links[$index] }}" alt="Profile Image"
                                                    class="img-thumbnail"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="profile_images" name="profile_images[]" class="form-control"
                                        type="file" multiple>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="opening_hours" value="{{ $hospital->opening_hours }}"
                                        name="opening_hours" type="text" class="form-control"
...
<script>
    ...
    $(document).ready(function() {
        ...
        mapboxgl.accessToken =
            'pk.eyJ1IjoiZW0yMDAwMTExIiwiYSI6ImNsajRrcXlicjA0MjMza3F6YjI5eW5pN2IifQ.bY21DI8kEvlV7z97OKlJJA';
        initMap();
    });
    let map;
    let marker;
