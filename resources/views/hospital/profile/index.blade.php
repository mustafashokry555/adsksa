                        ...
                        <div class="doc-info-left">
                            <div class="doctor-img">
                                @if ($hospital_admin->profile_image ?? '')
                                    <img src="{{ asset($hospital_admin->profile_image) }}" class="img-fluid" alt="User Image">
                                @else
    ...
    @endif
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($hospital_admin->country ?? '')
                                                <p>{{ $hospital_admin->country?->name }}</p>
                                            @else
                                                <p>N/A</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <h5>City</h5>
                                            @if ($hospital_admin->city ?? '')
                                                <p>{{ $hospital_admin->city?->name }}</p>
                                            @else
                                                <p>N/A</p>
                                            @endif
                                        </div>
                                    ...
                                    <div class="profile-list">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <h5>{{ __('hospital.profile.email') }}</h5>
