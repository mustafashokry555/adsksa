                        ...
                        <div class="comment">
                            ...
                            <div class="comment-body">
                                <div class="meta-data">
                                    ...
                                    <span class="comment-author">{{ $patient->name }}  {{ __('hospital.reviews.to_dr')  }}. {{ $doctor->name }}</span>
                                    </div>
                                    <span class="comment-date">{{ __('hospital.reviews.reviewed')  }} {{ $review->created_at->diffForHumans() }}</span>
