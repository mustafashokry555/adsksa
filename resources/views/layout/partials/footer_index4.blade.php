						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="footer-widget footer-about">
								<div class="footer-logo">
									<img src="{{ URL::asset('/assets/img/logo-one.png')}}" alt="logo">
								</div>
						...
						<div class="row aos" data-aos="fade-up">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu footer-menu-three">
									<ul>
										<li><a href="#">Hepatology</a>
										</li>
										<li><a href="#">Neurology</a>
										</li>
										<li><a href="#">Radiology</a>
										</li>
										<li><a href="#">Rhinology</a>
										</li>
										<li><a href="#">Obstetrics</a>
										</li>
									</ul>
								</div>
								<!-- /Footer Widget -->
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu footer-menu-three">
									<ul>
										...
										<li><a href="#">Oral Health</a>
										</li>
										<li><a href="#">Orthopedics</a>
										</li>
										<li><a href="#">Osteology</a>
										</li>
										<li><a href="#">Otology</a>
										</li>
									</ul>
