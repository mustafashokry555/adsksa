					...
					<ul class="nav header-navbar-rht">
						<li class="nav-item contact-item">
							...
							<div class="header-contact-detail">
								<p class="contact-info-header">Contact: {{ $setting->phone }}</p>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link header-login" href="{{url('login')}}"><img src="{{ URL::asset('/assets/img/login-btn.png')}}" alt="" class="img-fluid me-2">login / Signup </a>
						</li>
					</ul>
				</nav>
			</header>
